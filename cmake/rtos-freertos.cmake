...
IF(CMAKE_SYSTEM_PROCESSOR STREQUAL "cortex-m4")
    INCLUDE_DIRECTORIES(${STM32_PLATFORM_TOP}/freertos/Source/portable/ARM_CM4_MPU)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/freertos/Source/portable/ARM_CM4_MPU SRC_LIST)
    LIST(APPEND SRC_LIST ${STM32_PLATFORM_TOP}/freertos/Source/portable/Common/mpu_wrappers.c)
ELSEIF(CMAKE_SYSTEM_PROCESSOR STREQUAL "cortex-m3")
    INCLUDE_DIRECTORIES(${STM32_PLATFORM_TOP}/freertos/Source/portable/ARM_CM3_MPU)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/freertos/Source/portable/ARM_CM3_MPU SRC_LIST)
    LIST(APPEND SRC_LIST ${STM32_PLATFORM_TOP}/freertos/Source/portable/Common/mpu_wrappers.c)
