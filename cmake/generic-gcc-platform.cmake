...
IF(FPU_PRESENT EQUAL 1)
    ...
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/BasicMathFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/ComplexMathFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/FastMathFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/MatrixFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/SupportFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/CommonTables SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/ControllerFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/FilteringFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/StatisticsFunctions SRC_LIST)
    AUX_SOURCE_DIRECTORY(${STM32_PLATFORM_TOP}/arch/CMSIS/DSP_Lib/Source/TransformFunctions SRC_LIST)
